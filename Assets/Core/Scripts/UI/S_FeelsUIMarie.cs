...
public class S_FeelsUIMarie : MonoBehaviour
{
    public S_Currencies joyFeels, angerFeels, fearFeels, sadnessFeels, token;
    ...
    public void RefreshUI()
    {
        ...
        tokenValue.text = token.Amount.ToString();
    }
